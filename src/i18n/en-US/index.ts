...
export default {
  ...
  onboarding: {
    ...
    welcome_desc: 'A self-discovery game that helps you see your path with more clarity.',
    slide_1_title: 'Welcome to Lila',
    slide_1_desc:
      'The purpose of Lila is to help you see the inner causes of your situations and choose a clearer direction in life.',
    slide_1_point_1: 'The game turns your question into a clear path of steps, states, and insights.',
    slide_1_point_2: 'Each move helps you honestly see what supports you and what holds you back.',
    slide_1_point_3: 'You finish with clarity, focus, and one practical next step.',
    slide_2_title: 'Choose your game mode',
    slide_2_desc: 'Each mode offers a different depth of guidance and cost.',
    mode_free_title: 'Free',
    mode_free_desc:
      'Play without AI interpretation. We recommend writing your thoughts in a notebook or insights.',
    mode_free_price_tkn: '0 TKN',
    mode_ai_title: 'With AI Mentor',
    mode_ai_desc: 'AI interpretation for each move with full diary history for later analysis.',
    mode_ai_price_tkn: '10 TKN',
    mode_incognito_title: 'With AI Mentor (Incognito)',
    mode_incognito_desc:
      'AI answers and insights are stored temporarily for 72 hours, then removed permanently.',
    mode_incognito_price_tkn: '20 TKN',
    slide_3_title: 'How to play',
    slide_3_desc: 'Simple flow, step by step, at your own pace.',
    slide_3_point_1: 'Auto dice mode is enabled by default. You can switch to manual in profile.',
    slide_3_point_2: 'If you use a physical dice, enter the rolled value manually.',
    slide_3_point_3: 'You enter the game only with a 6. Keep rolling until it appears.',
    slide_4_title: 'Arrows and snakes',
    slide_4_desc: 'Transitions show your direction in the moment.',
    slide_4_point_1: 'Arrow lifts you up: support, momentum, and growth.',
    slide_4_point_2: 'Snake takes you down: a signal to pause and rethink the step.',
    slide_4_point_3: 'It is not about “good or bad”, but about your takeaway.',
    slide_5_title: 'Game diary',
    slide_5_desc: 'Your move history is available for review and analysis.',
    slide_5_point_1: 'Revisit each move in chronological order after the game.',
    slide_5_point_2: 'Save insights during play so key thoughts are not lost.',
    slide_5_point_3: 'Repeated cells, arrows, and snakes reveal patterns.',
    slide_6_title: 'Profile settings',
    slide_6_desc: 'Adjust the experience in a few taps.',
    slide_6_point_1: 'Sound and vibration.',
    slide_6_point_2: 'Dice mode switch: auto or manual.',
    slide_6_point_3: 'Chip color and chip text color.',
    slide_7_title: 'Before you start',
    slide_7_desc: 'The game works deeply with attention and inner state.',
    slide_7_point_1: 'Entry and exit meditations are required for safe practice.',
    slide_7_point_2: 'In Incognito mode, data is available only for 72 hours.',
    slide_7_point_3: 'Accept the rules and begin with a clear intention.',
